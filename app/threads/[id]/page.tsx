...
export default function ThreadPage({
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        setThread({
          ...threadData,
          authorName: threadData.is_anonymous
            ? "Anonymous"
            : threadProfile?.display_name || threadProfile?.email || "Unknown",
          authorAvatarUrl: threadData.is_anonymous
            ? null
            : threadProfile?.avatar_url || null,
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-purple-50 flex items-center justify-center px-4 pt-24">
        <motion.div
                      ...
                      >
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-3 border border-gray-200 shadow-sm">
                          <motion.div
                            ...
                            onClick={() =>
                              window.open(thread.image_url!, "_blank")
                            }
